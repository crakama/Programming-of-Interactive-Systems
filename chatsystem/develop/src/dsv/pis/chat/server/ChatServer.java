 ...
 */
public class ChatServer extends java.rmi.server.UnicastRemoteObject	// for Java RMI
    ...
    Runnable			// for the distribution thread.
{
 ...
 // protected Vector clients = new Vector ();
   ...
   */
  public ChatServer (String idName) throws java.io.IOException, java.rmi.RemoteException,	// if join doesn't work
